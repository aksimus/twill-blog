...
@section('content')
  ...
  <nav class="container mt-lg-4 pt-5" aria-label="breadcrumb">
    <ol class="breadcrumb mb-0 pt-5">
      ...
      <li class="breadcrumb-item">
        <a href="{{ route('blog.tags') }}">{{ __('Tags') }}</a>
      </li>
  ...
  <section class="container mt-4 mb-lg-5 pt-lg-2 pb-5">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="d-flex align-items-center justify-content-md-end">
          <div class="nav flex-nowrap me-sm-4 me-3">
            <a href="{{ route('blog.tag', $tag->getSlug()) }}" class="nav-link me-2 p-0 active" aria-label="List view">
    ...
    @empty
      <div class="text-center py-5">
        ...
        <a href="{{ route('blog.tags') }}" class="btn btn-primary me-2">
